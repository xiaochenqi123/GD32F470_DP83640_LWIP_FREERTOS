...
//****************************************************************************
{
    ...
    enet_phy_write_read(ENET_PHY_WRITE,portHandle->portMdioAddress, registerIndex, value);
}
...
NS_UINT data;
    ...
    enet_phy_write_read(ENET_PHY_READ,portHandle->portMdioAddress, registerIndex,&data );
